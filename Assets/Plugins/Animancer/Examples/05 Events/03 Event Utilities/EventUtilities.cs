...
namespace Animancer.Examples.Events
{
    ...
    /// <example>
    ///     <see href="https://kybernetik.com.au/animancer/docs/examples/events/utilities">Event Utilities</see>
    /// </example>
    ...
    public static class EventUtilities
    {
        ...
        /// </code>
        /// </example>
        public static readonly Action RestartCurrentState = () => { AnimancerEvent.CurrentState.Time = 0; };
