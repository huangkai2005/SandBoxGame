...
namespace Animancer
{
    ...
    public partial class ControllerState : AnimancerState, ICopyable<ControllerState>
    {
        ...
        protected override string UnsupportedSpeedMessage =>
            nameof(PlayableExtensions) + "." + nameof(PlayableExtensions.SetSpeed) + " does nothing on " +
            nameof(ControllerState) +
        ...
        {
            return fadeDuration >= 0 ? fadeDuration : AnimancerPlayable.DefaultFadeDuration;
        }
        ...
        public float SetFloat(string name, float value, float dampTime, float deltaTime,
        ...
        /// <summary>Sets the value of the specified float parameter with smoothing.</summary>
        public float SetFloat(int id, float value, float dampTime, float deltaTime,
            float maxSpeed = float.PositiveInfinity)
        {
            if (_SmoothingVelocities == null)
